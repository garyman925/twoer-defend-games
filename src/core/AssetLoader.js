...
export class AssetLoader {
  ...
  setupAssetLists() {
    ...
    this.assetCategories.images = [
      ...
      // 玩家資源
      { key: 'player_idle', path: 'assets/images/entities/player_idle.png' },
   ...
   */
  loadAllAssets() {
    console.log(`開始載入 ${this.totalAssets} 個資源...`);
