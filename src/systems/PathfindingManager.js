...
export class PathfindingManager {
  ...
  init() {
    ...
    this.gridWidth = Math.ceil(scaledWidth / this.gridSize);
    this.gridHeight = Math.ceil(scaledHeight / this.gridSize);
    
    // 創建空白網格
    this.createGrid();
    
    console.log(`尋路網格創建: ${this.gridWidth}x${this.gridHeight} (${this.gridSize}px每格)`);
    console.log(`地圖縮放: ${scale.toFixed(3)}, 縮放後尺寸: ${scaledWidth.toFixed(0)}x${scaledHeight.toFixed(0)}`);
  }
